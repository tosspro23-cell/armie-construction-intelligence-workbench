...
| `ConversationStore`/`AuditStore` interfaces + in-memory/JSONL (default) and Postgres (opt-in, `DATABASE_URL`) implementations (SPEC-M4, D-013) | `apps/api/app/persistence/` |
