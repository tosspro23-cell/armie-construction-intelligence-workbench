...
type FindingHistoryEntry = { id: string; from_status: FindingStatus | null; to_status: FindingStatus; actor_session_id: string | null; note: string | null; at: string };
type EngineeringFinding = {
  ...
  evidence_refs: string[]; created_at: string; updated_at: string; last_actor_session_id: string | null;
